...
```javascript
headercase = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/string-base-headercase@v0.2.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/string-base-headercase@v0.2.1-umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/string-base-headercase/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/string-base-headercase/actions/workflows/test.yml?query=branch:v0.2.1
